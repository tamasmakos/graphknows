...
```
Generate unit tests for [path or description of what to test]
```
...
| Agent | Purpose |
|-------|---------|
| `polyglot-test-generator` | Coordinates pipeline |
| `polyglot-test-researcher` | Analyzes codebase |
| `polyglot-test-planner` | Creates test plan |
| `polyglot-test-implementer` | Writes test files |
| `polyglot-test-builder` | Compiles code |
| `polyglot-test-tester` | Runs tests |
| `polyglot-test-fixer` | Fixes errors |
