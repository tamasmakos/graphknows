...
from src.kg.config.loader import load_config
from src.kg.config.schema import Config

# Add project root (workspace root) to Python path.
# This file lives at `src/app/infrastructure/config.py`, so we need to go
# four levels up: infrastructure -> app -> src -> project root.
